...
public class PositionInformationController {
    ...
    public ResponseEntity<ResponseBody<PositionInformation>> createPositionInformation(
        ...
        return ResponseBody
                .success(positionInformationService.createPositionInformation(companyinfoid, positionInformation));
    }

    @DeleteMapping("/{positioninfoid}")
    public ResponseEntity<ResponseBody<PositionInformation>> deletePositionInformation(
    ...
    public ResponseEntity<ResponseBody<PositionInformation>> updatePositionInformation(
            @PathVariable UUID positioninfoid,
            @Valid PositionInformation positionInformation) {
        return ResponseBody
                .success(positionInformationService.updatePositionInformation(positioninfoid, positionInformation));
    }

    @GetMapping("")
    public ResponseEntity<ResponseBody<List<PositionInformation>> getPositionInformations() {
        return ResponseBody
                .success(positionInformationService.getPositionInformations(companyinfoid));
    }

    @GetMapping("/{positioninfoid}")
    public ResponseEntity<ResponseBody<PositionInformation>> getPositionInformation(
            @PathVariable UUID positioninfoid) {
        return ResponseBody
                .success(positionInformationService.getPositionInformation(positioninfoid));
    }
